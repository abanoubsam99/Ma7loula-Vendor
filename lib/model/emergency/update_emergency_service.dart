class UpdateServiceEmergencyModel {
  String? message;
  Data? data;

  UpdateServiceEmergencyModel({this.message, this.data});

  UpdateServiceEmergencyModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    services =
        json['services'] != null ? Service.fromJson(json['services']) : null;
  }

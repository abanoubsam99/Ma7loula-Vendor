class EmergencyOffersModel {
  String? message;
  Data? data;

  EmergencyOffersModel({this.message, this.data});

  EmergencyOffersModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (acceptedOffer != null) {
      data['accepted_offer'] = acceptedOffer!.toJson();
    }
    if (requests != null) {
